...
.text
.protected Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1
.globl Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1
    .symbol: 'Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_BBH_MT32x256x32_SE_K1:
START_PROG:
...
MATH_WAVE:
    ...
    v_add_u32                                   v[29], v[26], v[28]
    v_add_u32                                   v[30], v[26], v[29]
    ...
    v_add_u32                                   v[48], v[15], v[24]
    v_add_u32                                   v[49], v[25], v[48]
    v_add_u32                                   v[50], v[25], v[49]
    v_add_u32                                   v[51], v[25], v[50]
    buffer_load_dwordx2                         v[32:33], v[27], s[32:35], 0 offen offset:0
    buffer_load_dwordx2                         v[36:37], v[28], s[32:35], 0 offen offset:0
    buffer_load_dwordx2                         v[40:41], v[29], s[32:35], 0 offen offset:0
    buffer_load_dwordx2                         v[44:45], v[30], s[32:35], 0 offen offset:0
    s_waitcnt                                   vmcnt(0)
    v_lshlrev_b32                               v[3], 16, v[33]
    v_lshrrev_b32                               v[33], 16, v[33]
    v_lshlrev_b32                               v[35], 16, v[33]
    v_mul_f32                                   v[34], s[15:15], v[3]
    v_mul_f32                                   v[35], s[15:15], v[35]
    v_lshlrev_b32                               v[3], 16, v[32]
    v_lshrrev_b32                               v[32], 16, v[32]
    v_lshlrev_b32                               v[33], 16, v[32]
    v_mul_f32                                   v[32], s[15:15], v[3]
    v_mul_f32                                   v[33], s[15:15], v[33]
    s_waitcnt                                   vmcnt(0)
    v_lshlrev_b32                               v[3], 16, v[37]
    v_lshrrev_b32                               v[37], 16, v[37]
    v_lshlrev_b32                               v[39], 16, v[37]
    v_mul_f32                                   v[38], s[15:15], v[3]
    v_mul_f32                                   v[39], s[15:15], v[39]
    v_lshlrev_b32                               v[3], 16, v[36]
    v_lshrrev_b32                               v[36], 16, v[36]
    v_lshlrev_b32                               v[37], 16, v[36]
    v_mul_f32                                   v[36], s[15:15], v[3]
    v_mul_f32                                   v[37], s[15:15], v[37]
    s_waitcnt                                   vmcnt(0)
    v_lshlrev_b32                               v[3], 16, v[41]
    v_lshrrev_b32                               v[41], 16, v[41]
    v_lshlrev_b32                               v[43], 16, v[41]
    v_mul_f32                                   v[42], s[15:15], v[3]
    v_mul_f32                                   v[43], s[15:15], v[43]
    v_lshlrev_b32                               v[3], 16, v[40]
    v_lshrrev_b32                               v[40], 16, v[40]
    v_lshlrev_b32                               v[41], 16, v[40]
    v_mul_f32                                   v[40], s[15:15], v[3]
    v_mul_f32                                   v[41], s[15:15], v[41]
    s_waitcnt                                   vmcnt(0)
    v_lshlrev_b32                               v[3], 16, v[45]
    v_lshrrev_b32                               v[45], 16, v[45]
    v_lshlrev_b32                               v[47], 16, v[45]
    v_mul_f32                                   v[46], s[15:15], v[3]
    v_mul_f32                                   v[47], s[15:15], v[47]
    v_lshlrev_b32                               v[3], 16, v[44]
    v_lshrrev_b32                               v[44], 16, v[44]
    v_lshlrev_b32                               v[45], 16, v[44]
    ...
    ds_read_b32                                 v[10], v[20]                             offset:1056
    ds_read_b32                                 v[11], v[20]                             offset:2112
    ds_read_b32                                 v[12], v[20]                             offset:3168
...
MATH_LOOP:
    ds_read_b32                                 v[13], v[16]                             offset:16
    ds_read_b32                                 v[52], v[20]                             offset:16
    ds_read_b32                                 v[53], v[20]                             offset:1072
    ds_read_b32                                 v[54], v[20]                             offset:2128
    ds_read_b32                                 v[55], v[20]                             offset:3184
    s_waitcnt                                   lgkmcnt(5)
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[8:8], v[9:9], acc[0:3]       
    v_mfma_f32_16x16x8bf16                      acc[4:7], v[8:8], v[10:10], acc[4:7]     
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[8:8], v[11:11], acc[8:11]   
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[8:8], v[12:12], acc[12:15] 
    ds_read_b32                                 v[8], v[16]                              offset:32
    ds_read_b32                                 v[9], v[20]                              offset:32
    ds_read_b32                                 v[10], v[20]                             offset:1088
    ds_read_b32                                 v[11], v[20]                             offset:2144
    ds_read_b32                                 v[12], v[20]                             offset:3200
    s_waitcnt                                   lgkmcnt(5)
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[13:13], v[52:52], acc[0:3]   
    v_mfma_f32_16x16x8bf16                      acc[4:7], v[13:13], v[53:53], acc[4:7]   
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[13:13], v[54:54], acc[8:11] 
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[13:13], v[55:55], acc[12:15] 
    ds_read_b32                                 v[13], v[16]                             offset:48
    ds_read_b32                                 v[52], v[20]                             offset:48
    ds_read_b32                                 v[53], v[20]                             offset:1104
    ds_read_b32                                 v[54], v[20]                             offset:2160
    ds_read_b32                                 v[55], v[20]                             offset:3216
    s_waitcnt                                   lgkmcnt(5)
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[8:8], v[9:9], acc[0:3]       
    v_mfma_f32_16x16x8bf16                      acc[4:7], v[8:8], v[10:10], acc[4:7]     
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[8:8], v[11:11], acc[8:11]   
    v_add_u32                                   v[15], v[15], 1
    v_cmp_eq_u32                                vcc, v[15], 3
    v_cndmask_b32                               v[14], v[15], 0, vcc                     
    v_mov_b32                                   v[15], v[14]
    v_mad_u32_u24                               v[16], v[19], v[14], v[17]               
    v_mad_u32_u24                               v[20], v[23], v[14], v[21]               
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[8:8], v[12:12], acc[12:15] 
    s_waitcnt                                   lgkmcnt(0)
    s_barrier
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[13:13], v[52:52], acc[0:3]   
...
END_MATH_LOOP:
    ...
    s_nop                                       4
    v_fma_f32                                   v[56], s[14:14], v[56], v[32]            
    v_accvgpr_read                              v[57], acc[1:1]
    s_nop                                       4
    v_fma_f32                                   v[57], s[14:14], v[57], v[33]            
    v_lshrrev_b32                               v[56], 16, v[56]
    v_and_or_b32                                v[56], v[57], v[24], v[56]               
    v_accvgpr_read                              v[58], acc[2:2]
    s_nop                                       4
    v_fma_f32                                   v[58], s[14:14], v[58], v[34]            
    v_accvgpr_read                              v[59], acc[3:3]
    s_nop                                       4
    v_fma_f32                                   v[59], s[14:14], v[59], v[35]            
    v_lshrrev_b32                               v[58], 16, v[58]
    v_and_or_b32                                v[57], v[59], v[24], v[58]               
    buffer_store_dwordx2                        v[56:57], v[48], s[36:39], 0 offen offset:0
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[13:13], v[54:54], acc[8:11] 
    v_accvgpr_read                              v[56], acc[4:4]
    s_nop                                       4
    v_fma_f32                                   v[56], s[14:14], v[56], v[36]            
    v_accvgpr_read                              v[57], acc[5:5]
    s_nop                                       4
    v_fma_f32                                   v[57], s[14:14], v[57], v[37]            
    v_lshrrev_b32                               v[56], 16, v[56]
    v_and_or_b32                                v[56], v[57], v[24], v[56]               
    v_accvgpr_read                              v[58], acc[6:6]
    s_nop                                       4
    v_fma_f32                                   v[58], s[14:14], v[58], v[38]            
    v_accvgpr_read                              v[59], acc[7:7]
    s_nop                                       4
    v_fma_f32                                   v[59], s[14:14], v[59], v[39]            
    v_lshrrev_b32                               v[58], 16, v[58]
    v_and_or_b32                                v[57], v[59], v[24], v[58]               
    buffer_store_dwordx2                        v[56:57], v[49], s[36:39], 0 offen offset:0
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[13:13], v[55:55], acc[12:15] 
    v_accvgpr_read                              v[56], acc[8:8]
    s_nop                                       4
    v_fma_f32                                   v[56], s[14:14], v[56], v[40]            
    v_accvgpr_read                              v[57], acc[9:9]
    s_nop                                       4
    v_fma_f32                                   v[57], s[14:14], v[57], v[41]            
    v_lshrrev_b32                               v[56], 16, v[56]
    v_and_or_b32                                v[56], v[57], v[24], v[56]               
    v_accvgpr_read                              v[58], acc[10:10]
    s_nop                                       4
    v_fma_f32                                   v[58], s[14:14], v[58], v[42]            
    v_accvgpr_read                              v[59], acc[11:11]
    s_nop                                       4
    v_fma_f32                                   v[59], s[14:14], v[59], v[43]            
    v_lshrrev_b32                               v[58], 16, v[58]
    v_and_or_b32                                v[57], v[59], v[24], v[58]               
    buffer_store_dwordx2                        v[56:57], v[50], s[36:39], 0 offen offset:0
    v_accvgpr_read                              v[56], acc[12:12]
    s_nop                                       4
    v_fma_f32                                   v[56], s[14:14], v[56], v[44]            
    v_accvgpr_read                              v[57], acc[13:13]
    s_nop                                       4
    v_fma_f32                                   v[57], s[14:14], v[57], v[45]            
    v_lshrrev_b32                               v[56], 16, v[56]
    v_and_or_b32                                v[56], v[57], v[24], v[56]               
    v_accvgpr_read                              v[58], acc[14:14]
    s_nop                                       4
    v_fma_f32                                   v[58], s[14:14], v[58], v[46]            
    v_accvgpr_read                              v[59], acc[15:15]
    s_nop                                       4
    v_fma_f32                                   v[59], s[14:14], v[59], v[47]            
    v_lshrrev_b32                               v[58], 16, v[58]
    v_and_or_b32                                v[57], v[59], v[24], v[58]               
    buffer_store_dwordx2                        v[56:57], v[51], s[36:39], 0 offen offset:0
END_PROG:
    s_endpgm
