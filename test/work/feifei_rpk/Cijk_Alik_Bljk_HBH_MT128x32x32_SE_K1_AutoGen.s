...
.text
.protected Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1
.globl Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1
    .symbol: 'Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HBH_MT128x32x32_SE_K1:
START_PROG:
    ...
    s_mul_i32                                   s[5], 2, s[27]
    s_add_u32                                   s[28], s[5], s[26]
    s_lshr_b32                                  s[29], s[26], 1
    s_and_b32                                   s[5], 1, s[26]
    s_mov_b32                                   s[26], s[5]
    v_mov_b32                                   v[7], s[5]
...
FETCH_LOOP:
    ...
    buffer_load_dword                           v[3], v[32], s[44:47], 0 offen offset:528 lds
    buffer_load_dword                           v[3], v[33], s[44:47], 0 offen offset:792 lds
    ...
    v_add_u32                                   v[32], 64, v[32]
    v_add_u32                                   v[33], 64, v[33]
    s_waitcnt                                   vmcnt(0)
    s_barrier
...
MATH_WAVE:
    ...
    v_add_u32                                   v[18], 8448, v[17]
    v_xor_b32                                   v[19], v[18], v[17]
    v_mov_b32                                   v[16], v[17]
    v_lshrrev_b32                               v[8], 1, s[26]
    ...
    v_mov_b32                                   v[3], 0x0+16896
    v_add_u32                                   v[21], v[21], v[3]
    v_add_u32                                   v[21], v[21], v[15]
    v_add_u32                                   v[22], 2112, v[21]
    ...
    s_lshr_b32                                  s[5], s[26], 1
    v_lshlrev_b32                               v[8], 5, s[5]
    s_and_b32                                   s[5], s[26], 1
    ...
    v_add_u32                                   v[62], v[15], v[24]
    v_add_u32                                   v[63], v[25], v[62]
    buffer_load_dwordx2                         v[30:31], v[27], s[32:35], 0 offen offset:0
    buffer_load_dwordx2                         v[34:35], v[27], s[32:35], 0 offen offset:32
    buffer_load_dwordx2                         v[38:39], v[27], s[32:35], 0 offen offset:64
    buffer_load_dwordx2                         v[42:43], v[27], s[32:35], 0 offen offset:96
    buffer_load_dwordx2                         v[46:47], v[28], s[32:35], 0 offen offset:0
    buffer_load_dwordx2                         v[50:51], v[28], s[32:35], 0 offen offset:32
    buffer_load_dwordx2                         v[54:55], v[28], s[32:35], 0 offen offset:64
    buffer_load_dwordx2                         v[58:59], v[28], s[32:35], 0 offen offset:96
    ...
    s_waitcnt                                   vmcnt(0)
    v_cvt_f32_f16                               v[3], v[47]
    v_lshrrev_b32                               v[47], 16, v[47]
    v_cvt_f32_f16                               v[49], v[47]
    v_mul_f32                                   v[48], s[15:15], v[3]
    v_mul_f32                                   v[49], s[15:15], v[49]
    v_cvt_f32_f16                               v[3], v[46]
    v_lshrrev_b32                               v[46], 16, v[46]
    v_cvt_f32_f16                               v[47], v[46]
    v_mul_f32                                   v[46], s[15:15], v[3]
    v_mul_f32                                   v[47], s[15:15], v[47]
    s_waitcnt                                   vmcnt(0)
    v_cvt_f32_f16                               v[3], v[51]
    v_lshrrev_b32                               v[51], 16, v[51]
    v_cvt_f32_f16                               v[53], v[51]
    v_mul_f32                                   v[52], s[15:15], v[3]
    v_mul_f32                                   v[53], s[15:15], v[53]
    v_cvt_f32_f16                               v[3], v[50]
    v_lshrrev_b32                               v[50], 16, v[50]
    v_cvt_f32_f16                               v[51], v[50]
    v_mul_f32                                   v[50], s[15:15], v[3]
    v_mul_f32                                   v[51], s[15:15], v[51]
    s_waitcnt                                   vmcnt(0)
    v_cvt_f32_f16                               v[3], v[55]
    v_lshrrev_b32                               v[55], 16, v[55]
    v_cvt_f32_f16                               v[57], v[55]
    v_mul_f32                                   v[56], s[15:15], v[3]
    v_mul_f32                                   v[57], s[15:15], v[57]
    v_cvt_f32_f16                               v[3], v[54]
    v_lshrrev_b32                               v[54], 16, v[54]
    v_cvt_f32_f16                               v[55], v[54]
    v_mul_f32                                   v[54], s[15:15], v[3]
    v_mul_f32                                   v[55], s[15:15], v[55]
    s_waitcnt                                   vmcnt(0)
    v_cvt_f32_f16                               v[3], v[59]
    v_lshrrev_b32                               v[59], 16, v[59]
    v_cvt_f32_f16                               v[61], v[59]
    v_mul_f32                                   v[60], s[15:15], v[3]
    v_mul_f32                                   v[61], s[15:15], v[61]
    v_cvt_f32_f16                               v[3], v[58]
    v_lshrrev_b32                               v[58], 16, v[58]
    v_cvt_f32_f16                               v[59], v[58]
    v_mul_f32                                   v[58], s[15:15], v[3]
    ...
    ds_read_b64                                 v[12:13], v[16]                          offset:2112
    ds_read_b64                                 v[14:15], v[16]                          offset:3168
    ds_read_b64                                 v[64:65], v[20]
    ds_read_b64                                 v[66:67], v[20]                          offset:1056
    s_lshr_b32                                  s[5], 480, 5
    s_cmp_le_u32                                s[5], 1
    s_cbranch_scc1                              END_MATH_LOOP
    s_sub_u32                                   s[5], s[5], 1
    s_sub_u32                                   s[31], s[5], 1
MATH_LOOP:
    ds_read_b64                                 v[68:69], v[16]                          offset:32
    ds_read_b64                                 v[70:71], v[16]                          offset:1088
    ds_read_b64                                 v[72:73], v[16]                          offset:2144
    ds_read_b64                                 v[74:75], v[16]                          offset:3200
    ds_read_b64                                 v[76:77], v[20]                          offset:32
    ds_read_b64                                 v[78:79], v[20]                          offset:1088
    s_waitcnt                                   lgkmcnt(6)
    v_mfma_f32_16x16x16f16                      acc[0:3], v[8:9], v[64:65], acc[0:3]     
    v_mfma_f32_16x16x16f16                      acc[4:7], v[10:11], v[64:65], acc[4:7]   
    v_mfma_f32_16x16x16f16                      acc[8:11], v[12:13], v[64:65], acc[8:11] 
    v_mfma_f32_16x16x16f16                      acc[12:15], v[14:15], v[64:65], acc[12:15] 
    v_mfma_f32_16x16x16f16                      acc[16:19], v[8:9], v[66:67], acc[16:19] 
    v_mfma_f32_16x16x16f16                      acc[20:23], v[10:11], v[66:67], acc[20:23] 
    v_mfma_f32_16x16x16f16                      acc[24:27], v[12:13], v[66:67], acc[24:27] 
    v_xor_b32                                   v[16], v[19], v[16]
    v_xor_b32                                   v[20], v[23], v[20]
    v_xor_b32                                   v[18], v[19], v[16]
    v_xor_b32                                   v[22], v[23], v[20]
    v_mfma_f32_16x16x16f16                      acc[28:31], v[14:15], v[66:67], acc[28:31] 
    s_waitcnt                                   lgkmcnt(0)
    s_barrier
    v_mfma_f32_16x16x16f16                      acc[0:3], v[68:69], v[76:77], acc[0:3]   
    ds_read_b64                                 v[8:9], v[16]
    ds_read_b64                                 v[10:11], v[16]                          offset:1056
    ds_read_b64                                 v[12:13], v[16]                          offset:2112
    ds_read_b64                                 v[14:15], v[16]                          offset:3168
    ds_read_b64                                 v[64:65], v[20]
    ds_read_b64                                 v[66:67], v[20]                          offset:1056
    v_mfma_f32_16x16x16f16                      acc[4:7], v[70:71], v[76:77], acc[4:7]   
    v_mfma_f32_16x16x16f16                      acc[8:11], v[72:73], v[76:77], acc[8:11] 
    v_mfma_f32_16x16x16f16                      acc[12:15], v[74:75], v[76:77], acc[12:15] 
    v_mfma_f32_16x16x16f16                      acc[16:19], v[68:69], v[78:79], acc[16:19] 
    v_mfma_f32_16x16x16f16                      acc[20:23], v[70:71], v[78:79], acc[20:23] 
    v_mfma_f32_16x16x16f16                      acc[24:27], v[72:73], v[78:79], acc[24:27] 
    v_mfma_f32_16x16x16f16                      acc[28:31], v[74:75], v[78:79], acc[28:31] 
...
END_MATH_LOOP:
    ...
    v_mfma_f32_16x16x16f16                      acc[24:27], v[72:73], v[78:79], acc[24:27] 
    v_mfma_f32_16x16x16f16                      acc[28:31], v[74:75], v[78:79], acc[28:31] 
    v_mov_b32                                   v[12], 0x0+4294901760
    s_nop                                       32
    v_accvgpr_read                              v[8], acc[0:0]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[30]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[1:1]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[31]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[2:2]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[32]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[3:3]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[33]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[62], s[36:39], 0 offen offset:0
    v_accvgpr_read                              v[8], acc[4:4]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[34]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[5:5]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[35]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[6:6]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[36]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[7:7]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[37]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[62], s[36:39], 0 offen offset:32
    v_accvgpr_read                              v[8], acc[8:8]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[38]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[9:9]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[39]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[10:10]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[40]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[11:11]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[41]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[62], s[36:39], 0 offen offset:64
    v_accvgpr_read                              v[8], acc[12:12]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[42]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[13:13]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[43]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[14:14]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[44]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[15:15]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[45]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[62], s[36:39], 0 offen offset:96
    v_accvgpr_read                              v[8], acc[16:16]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[46]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[17:17]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[47]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[18:18]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[48]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[19:19]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[49]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[63], s[36:39], 0 offen offset:0
    v_accvgpr_read                              v[8], acc[20:20]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[50]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[21:21]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[51]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[22:22]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[52]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[23:23]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[53]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[63], s[36:39], 0 offen offset:32
    v_accvgpr_read                              v[8], acc[24:24]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[54]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[25:25]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[55]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[26:26]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[56]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[27:27]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[57]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[63], s[36:39], 0 offen offset:64
    v_accvgpr_read                              v[8], acc[28:28]
    s_nop                                       4
    v_fma_f32                                   v[8], s[14:14], v[8], v[58]              
    v_cvt_f16_f32                               v[8], v[8]
    v_accvgpr_read                              v[9], acc[29:29]
    s_nop                                       4
    v_fma_f32                                   v[9], s[14:14], v[9], v[59]              
    v_cvt_f16_f32                               v[9], v[9]
    v_pack_b32_f16                              v[8], v[8], v[9]
    v_accvgpr_read                              v[10], acc[30:30]
    s_nop                                       4
    v_fma_f32                                   v[10], s[14:14], v[10], v[60]            
    v_cvt_f16_f32                               v[10], v[10]
    v_accvgpr_read                              v[11], acc[31:31]
    s_nop                                       4
    v_fma_f32                                   v[11], s[14:14], v[11], v[61]            
    v_cvt_f16_f32                               v[11], v[11]
    v_pack_b32_f16                              v[9], v[10], v[11]
    buffer_store_dwordx2                        v[8:9], v[63], s[36:39], 0 offen offset:96
END_PROG:
    s_endpgm
