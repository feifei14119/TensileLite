...
.text
.protected Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1
.globl Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1
    .symbol: 'Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_SB_MT32x256x16_SE_K1:
START_PROG:
...
MATH_WAVE:
    ...
    ds_read_b32                                 v[11], v[20]                             offset:1056
    s_lshr_b32                                  s[5], 2048, 4
    s_cmp_le_u32                                s[5], 1
...
MATH_LOOP:
    ...
    ds_read_b32                                 v[13], v[16]                             offset:1072
    ...
    ds_read_b32                                 v[11], v[20]                             offset:1088
    s_waitcnt                                   lgkmcnt(4)
    ...
    ds_read_b32                                 v[13], v[16]                             offset:1104
