...
.text
.protected Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1
.globl Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1
    .symbol: 'Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HBH_MT128x32x64_SE_K1:
START_PROG:
...
MATH_WAVE:
    ...
    ds_read_b64                                 v[10:11], v[16]                          offset:2112
    ds_read_b64                                 v[12:13], v[20]
    ds_read_b64                                 v[14:15], v[20]                          offset:2112
    s_lshr_b32                                  s[5], 480, 6
    s_cmp_le_u32                                s[5], 1
...
MATH_LOOP:
    ...
    ds_read_b64                                 v[50:51], v[16]                          offset:2144
    ds_read_b64                                 v[52:53], v[20]                          offset:32
    ds_read_b64                                 v[54:55], v[20]                          offset:2144
    s_waitcnt                                   lgkmcnt(4)
    ...
    ds_read_b64                                 v[10:11], v[16]                          offset:2176
    ds_read_b64                                 v[12:13], v[20]                          offset:64
    ds_read_b64                                 v[14:15], v[20]                          offset:2176
    s_waitcnt                                   lgkmcnt(4)
    ...
    ds_read_b64                                 v[48:49], v[16]                          offset:96
    ds_read_b64                                 v[50:51], v[16]                          offset:2208
    ds_read_b64                                 v[52:53], v[20]                          offset:96
    ds_read_b64                                 v[54:55], v[20]                          offset:2208
    s_waitcnt                                   lgkmcnt(4)
    v_mfma_f32_16x16x16f16                      acc[0:3], v[8:9], v[12:13], acc[0:3]     
    v_mfma_f32_16x16x16f16                      acc[4:7], v[10:11], v[12:13], acc[4:7]   
    v_mfma_f32_16x16x16f16                      acc[8:11], v[8:9], v[14:15], acc[8:11]   
