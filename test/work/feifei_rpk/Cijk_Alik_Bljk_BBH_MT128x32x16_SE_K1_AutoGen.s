...
.text
.protected Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1
.globl Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1
    .symbol: 'Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_BBH_MT128x32x16_SE_K1:
START_PROG:
    ...
    v_lshrrev_b32                               v[9], 3, v[6]
    v_and_b32                                   v[10], 7, v[6]
    ...
    v_add_u32                                   v[14], 32, v[14]
    v_add_u32                                   v[15], 32, v[15]
    v_add_u32                                   v[16], 32, v[16]
    v_add_u32                                   v[17], 32, v[17]
    v_add_u32                                   v[18], 32, v[18]
...
MATH_WAVE:
    ...
    ds_read_b32                                 v[9], v[16]                              offset:528
    ds_read_b32                                 v[10], v[20]
    ds_read_b32                                 v[11], v[20]                             offset:528
...
MATH_LOOP:
    ...
    ds_read_b32                                 v[13], v[16]                             offset:544
    ds_read_b32                                 v[14], v[20]                             offset:16
    ds_read_b32                                 v[15], v[20]                             offset:544
    s_waitcnt                                   lgkmcnt(4)
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[8:8], v[10:10], acc[0:3]     
    v_mfma_f32_16x16x8bf16                      acc[4:7], v[9:9], v[10:10], acc[4:7]     
    ...
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[9:9], v[11:11], acc[12:15] 
    s_waitcnt                                   lgkmcnt(0)
    s_barrier
    v_mfma_f32_16x16x8bf16                      acc[0:3], v[12:12], v[14:14], acc[0:3]   
    ds_read_b32                                 v[8], v[16]
    ds_read_b32                                 v[9], v[16]                              offset:528
    ds_read_b32                                 v[10], v[20]
    ds_read_b32                                 v[11], v[20]                             offset:528
    v_mfma_f32_16x16x8bf16                      acc[4:7], v[13:13], v[14:14], acc[4:7]   
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[12:12], v[15:15], acc[8:11] 
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[13:13], v[15:15], acc[12:15] 
...
END_MATH_LOOP:
    ...
    s_nop                                       4
    v_fma_f32                                   v[48], s[14:14], v[48], v[30]            
    v_accvgpr_read                              v[49], acc[1:1]
    s_nop                                       4
    v_fma_f32                                   v[49], s[14:14], v[49], v[31]            
    v_lshrrev_b32                               v[48], 16, v[48]
    v_and_or_b32                                v[48], v[49], v[26], v[48]               
    v_accvgpr_read                              v[50], acc[2:2]
    s_nop                                       4
    v_fma_f32                                   v[50], s[14:14], v[50], v[32]            
    v_accvgpr_read                              v[51], acc[3:3]
    s_nop                                       4
    v_fma_f32                                   v[51], s[14:14], v[51], v[33]            
    v_lshrrev_b32                               v[50], 16, v[50]
    v_and_or_b32                                v[49], v[51], v[26], v[50]               
    buffer_store_dwordx2                        v[48:49], v[46], s[36:39], 0 offen offset:0
    v_mfma_f32_16x16x8bf16                      acc[8:11], v[12:12], v[15:15], acc[8:11] 
    v_accvgpr_read                              v[48], acc[4:4]
    s_nop                                       4
    v_fma_f32                                   v[48], s[14:14], v[48], v[34]            
    v_accvgpr_read                              v[49], acc[5:5]
    s_nop                                       4
    v_fma_f32                                   v[49], s[14:14], v[49], v[35]            
    v_lshrrev_b32                               v[48], 16, v[48]
    v_and_or_b32                                v[48], v[49], v[26], v[48]               
    v_accvgpr_read                              v[50], acc[6:6]
    s_nop                                       4
    v_fma_f32                                   v[50], s[14:14], v[50], v[36]            
    v_accvgpr_read                              v[51], acc[7:7]
    s_nop                                       4
    v_fma_f32                                   v[51], s[14:14], v[51], v[37]            
    v_lshrrev_b32                               v[50], 16, v[50]
    v_and_or_b32                                v[49], v[51], v[26], v[50]               
    buffer_store_dwordx2                        v[48:49], v[46], s[36:39], 0 offen offset:32
    v_mfma_f32_16x16x8bf16                      acc[12:15], v[13:13], v[15:15], acc[12:15] 
    v_accvgpr_read                              v[48], acc[8:8]
    s_nop                                       4
    v_fma_f32                                   v[48], s[14:14], v[48], v[38]            
    v_accvgpr_read                              v[49], acc[9:9]
    s_nop                                       4
    v_fma_f32                                   v[49], s[14:14], v[49], v[39]            
    v_lshrrev_b32                               v[48], 16, v[48]
    v_and_or_b32                                v[48], v[49], v[26], v[48]               
    v_accvgpr_read                              v[50], acc[10:10]
    s_nop                                       4
    v_fma_f32                                   v[50], s[14:14], v[50], v[40]            
    v_accvgpr_read                              v[51], acc[11:11]
    s_nop                                       4
    v_fma_f32                                   v[51], s[14:14], v[51], v[41]            
    v_lshrrev_b32                               v[50], 16, v[50]
    v_and_or_b32                                v[49], v[51], v[26], v[50]               
    buffer_store_dwordx2                        v[48:49], v[47], s[36:39], 0 offen offset:0
    v_accvgpr_read                              v[48], acc[12:12]
    s_nop                                       4
    v_fma_f32                                   v[48], s[14:14], v[48], v[42]            
    v_accvgpr_read                              v[49], acc[13:13]
    s_nop                                       4
    v_fma_f32                                   v[49], s[14:14], v[49], v[43]            
    v_lshrrev_b32                               v[48], 16, v[48]
    v_and_or_b32                                v[48], v[49], v[26], v[48]               
    v_accvgpr_read                              v[50], acc[14:14]
    s_nop                                       4
    v_fma_f32                                   v[50], s[14:14], v[50], v[44]            
    v_accvgpr_read                              v[51], acc[15:15]
    s_nop                                       4
    v_fma_f32                                   v[51], s[14:14], v[51], v[45]            
    v_lshrrev_b32                               v[50], 16, v[50]
    v_and_or_b32                                v[49], v[51], v[26], v[50]               
    buffer_store_dwordx2                        v[48:49], v[47], s[36:39], 0 offen offset:32
END_PROG:
    s_endpgm
