...
.text
.protected Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1
.globl Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1
...
amdhsa.version: [ 1, 0 ]
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1
    .symbol: 'Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1.kd'
    .language: OpenCL C
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_SB_MT128x32x16_SE_K1:
START_PROG:
...
MATH_WAVE:
    ...
    buffer_load_dwordx4                         v[32:35], v[27], s[32:35], 0 offen offset:64
    s_waitcnt                                   vmcnt(0)
...
MATH_LOOP:
    ...
    s_waitcnt                                   lgkmcnt(3)
    v_mfma_f32_16x16x4f32                       acc[0:3], v[11:11], v[13:13], acc[0:3]   
    v_mfma_f32_16x16x4f32                       acc[4:7], v[12:12], v[13:13], acc[4:7]   
...
END_MATH_LOOP:
    ...
    buffer_store_dwordx4                        v[36:39], v[26], s[36:39], 0 offen offset:0
    ...
    buffer_store_dwordx4                        v[36:39], v[26], s[36:39], 0 offen offset:64
END_PROG:
    s_endpgm
